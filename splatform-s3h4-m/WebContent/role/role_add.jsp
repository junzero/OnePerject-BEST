...
<!-- END content -->
  ...
  <SCRIPT type="text/javascript">
		...
		function onCheck(e, treeId, treeNode) {
    		...
    		//4.设置以及选择的角色id
    		if(document.getElementById("roleMenuStr").value==""){										
    			document.getElementById("roleMenuStr").value = roleStr;
    		}else{
    			//先清空表单的值
    			document.getElementById("roleMenuStr").value="";
    		}
    		document.getElementById("roleMenuStr").value = roleStr;
    		//5.传入后台的字符串
