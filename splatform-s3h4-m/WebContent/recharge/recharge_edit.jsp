...
<body>
	<div id="wrap">
		<form method="post" id="editForm" name="editForm"
						action="<spring:url value='/rechargeEdit.do' htmlEscape='true'/>" target="_self">
					...
					<div class="row">
  					...
  					<div class="row">
    					...
    					<input type="text" class="form-control" id="money" name="money" datatype="/^[0-9]+(\.[0-9]{1,2})?$/i" nullmsg="充值金额必填" errormsg="请输入正确的金额"
    					 value="${recharge.money }" placeholder="充值金额必填">
						<div class="info"><span class="Validform_checktip"></span><span class="dec"><s class="dec1">&#9670;</s><s class="dec2">&#9670;</s></span></div>
  					</div>
  					</div>
				...
				$(document).ready(function() {
					...
					$.ajax({  
					    ...
					    success:function(data){  
							 ...
							 $('#cardNum').val("${recharge.cardNum}").trigger("change");
						},  
						error:function(){}  
					}); 
