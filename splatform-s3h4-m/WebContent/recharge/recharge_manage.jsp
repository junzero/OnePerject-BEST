...
<body class="padTop53 " >
                ...
                <div class="row">
	                ...
	                <div class="page-header mr0">
						<form id="aUserSearchForm" name="aUserSearchForm"
							action="<spring:url value='/rechargeManager.do' htmlEscape='true'/>"
		            		...
		            		<div class="form-group">
								<div class="">
									...
									<input id="name" class="form-control" type="text" name="cardNum" value="${cardNum }"
										placeholder="会员卡号"> 
									<input id="name" class="form-control" type="text" name="mobile" value="${mobile }"
										placeholder="手机号"> 
									<input id="name" class="form-control" type="text" name="memberName" value="${memberName }"
										placeholder="会员姓名"> 
															...
															<div class="btn-group">
																...
																<ul class="dropdown-menu">
																	<li><a data-toggle="modal" href="#auserEdit" title="编辑会员卡"
																		onClick="editrecord('${recharge.id}');">编辑</a></li>
																	<li><a data-toggle="modal" href="#auserDel" title="删除会员卡"  onClick="delrecord('${recharge.id}');">删除</a></li>
    ...
    var addrecord = function(){
    		...
    		diag.Height = 360;
    		diag.Width = 600;
        	diag.Title = "系统管理-充值记录新增";
        	diag.URL = "<%=path %>/toAddRecharge.do";
    ...
    var editrecord = function(id){
    		...
    		diag.Height = 360;
    		diag.Width = 600;
    		diag.Title = "系统管理-充值记录编辑";
        	diag.URL = "<%=path %>/toEditRecharge.do?id="+id;
        	diag.OKEvent = function(){
    ...
    var delrecord= function(id){
    	$('#del_recordId').val(id);
    	zDialog.confirm('警告：您确认要删除该充值记录吗？',function(){
...
<form id="delForm" name="delForm" method="post" action="delRecharge.do" target="thisFrame">
