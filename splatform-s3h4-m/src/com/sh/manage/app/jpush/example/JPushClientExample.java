package com.sh.manage.app.jpush.example;
import java.util.HashMap;
import java.util.Map;

import com.sh.manage.app.jpush.api.ErrorCodeEnum;
import com.sh.manage.app.jpush.api.IOSExtra;
import com.sh.manage.app.jpush.api.JPushClient;
...
public class JPushClientExample {
	...
	private static final String masterSecret = "13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
