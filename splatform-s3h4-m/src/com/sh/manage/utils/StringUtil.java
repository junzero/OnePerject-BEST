...
public class StringUtil {
     ...
     * 返回0~limit长度的截取字符串.
     * 
     * @History: Apr 20, 2010 9:41:42 AM  <br>
     *           把参数s修改为str <br>
     *           把变量x修改为tmpLoc <br>
     * @param str
     *            输入的字符串
     ...
     * 判断两个字符串是否相等
     * 
     * @History: Apr 20, 2010 9:44:07 AM  <br>
     ...
     * 
     * @History: Apr 20, 2010 1:08:51 PM  <br>
     ...
     * 补0函数
     * 
     * @History: Apr 20, 2010 9:46:18 AM  <br>
     ...
     * 将字符串转换成布尔型
     * 
     * @History: Apr 20, 2010 9:47:24 AM  <br>
     *           把参数def修改为isDef <br>
     * @param str
     *            字符串
     * @param isDef
     ...
     * 判断字符串是否为Integer
     * 
     * @History: Apr 20, 2010 9:23:41 AM  <br>
     *           把参数s修改为str <br>
     * @param str
     *            字符串
     ...
     * iso-8859-1转码为GBK
     * 
     * @History: Apr 20, 2010 9:24:52 AM  <br>
     *           把参数s修改为str <br>
     * @param str
     *            字符串
     * @throws UnsupportedEncodingException
     ...
     * 对数组中的字符串以逗号进行组合
     * 
     * @History: Apr 20, 2010 2:50:33 PM  <br>
     *           添加方法注释
     * @param source
     *            字符串数组
     * @return 字符串
     ...
     * 组合字符串数组为字符串
     * 
     * @History: Apr 20, 2010 9:26:43 AM  <br>
     *           把参数s修改为strSource <br>
     ...
     * 
     * @History: Apr 20, 2010 9:27:55 AM  <br>
     *           把参数s修改为strTime <br>
     * @param strTime
     ...
     * 分割字符串为数组
     * 
     * @History: Apr 20, 2010 9:31:54 AM  <br>
     *           把参数1修改strSource <br>
     *           把参数2修改为strSplit <br>
     ...
     * 
     * @History: Apr 20, 2010 9:32:32 AM  <br>
     *           把参数s修改为str <br>
     * @param str
     *            字符串
     * @return 长度
     ...
     * 字符串替换函数
     * 
     * @History: Apr 20, 2010 9:36:05 AM  <br>
     *           把参数1修改为strSource <br>
